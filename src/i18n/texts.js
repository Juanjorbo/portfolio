      ...
      items: [
        {
          ...
          desc: [
            "Desarrollo de aplicaciones internas para la gestión de procesos.",
            "Diseño e implementación de pipelines de CI para automatizar procesos de build, testing y validación.",
            "Automatización de tareas operativas mediante PowerShell y Bash.",
            "Administración de sistemas Windows.",
            "Monitorización de aplicaciones y sistemas para garantizar rendimiento y disponibilidad.",
            "Gestión básica de servidores y trabajo con bases de datos SQL.",
            "Resolución de incidencias técnicas relacionadas con software y sistemas.",
          ],
        },
        {
      ...
      items: [
        {
          ...
          desc: [
            "Development of internal applications for process management.",
            "Design and implementation of CI pipelines to automate build, testing, and validation processes.",
            "Task automation using PowerShell and Bash.",
            "Windows system administration.",
            "Monitoring of applications and systems.",
            "Basic server management and work with SQL databases.",
            "Troubleshooting technical issues related to software and systems.",
          ],
        },
        {
